...
//   dots: "bg-[radial-gradient(circle_at_1px_1px,rgba(0,0,0,0.4)_1px,transparent_0)] bg-[length:24px_24px]",
...
const texturePatterns: Record<TextureType, string> = {
  ...
  grid: `
    ...
    dark:bg-[linear-gradient(rgba(255,255,255,0.2)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.2)_1px,transparent_1px)]
    bg-[length:32px_32px]
  `,
  ...
  crosshatch: `
    bg-[repeating-linear-gradient(45deg,transparent,transparent_2px,rgba(0,0,0,0.3)_2px,rgba(0,0,0,0.3)_4px),
        repeating-linear-gradient(-45deg,transparent,transparent_2px,rgba(0,0,0,0.3)_2px,rgba(0,0,0,0.3)_4px)]
    dark:bg-[repeating-linear-gradient(45deg,transparent,transparent_2px,rgba(255,255,255,0.2)_2px,rgba(255,255,255,0.2)_4px),
              repeating-linear-gradient(-45deg,transparent,transparent_2px,rgba(255,255,255,0.2)_2px,rgba(255,255,255,0.2)_4px)]
  `,

  diagonal: `
    bg-[repeating-linear-gradient(-45deg,rgba(0,0,0,0.2),rgba(0,0,0,0.2)_1px,transparent_1px,transparent_6px)]
    dark:bg-[repeating-linear-gradient(-45deg,rgba(255,255,255,0.12),rgba(255,255,255,0.12)_1px,transparent_1px,transparent_6px)]
  `,

  scatteredDots: `
    bg-[radial-gradient(circle_at_3px_7px,rgba(0,0,0,0.3)_1px,transparent_0),
        radial-gradient(circle_at_11px_2px,rgba(0,0,0,0.3)_1px,transparent_0),
        radial-gradient(circle_at_7px_12px,rgba(0,0,0,0.3)_1px,transparent_0)]
    dark:bg-[radial-gradient(circle_at_3px_7px,rgba(255,255,255,0.18)_1px,transparent_0),
              radial-gradient(circle_at_11px_2px,rgba(255,255,255,0.18)_1px,transparent_0),
              radial-gradient(circle_at_7px_12px,rgba(255,255,255,0.18)_1px,transparent_0)]
    bg-[length:16px_16px]
  `,

  halftone: `
    bg-[radial-gradient(circle,rgba(0,0,0,0.4)_25%,transparent_25%)]
    dark:bg-[radial-gradient(circle,rgba(255,255,255,0.22)_25%,transparent_25%)]
    bg-[length:10px_10px]
  ...
  triangular: `
    ...
    dark:bg-[conic-gradient(from_0deg_at_50%_50%,rgba(255,255,255,0.2)_0deg_120deg,transparent_120deg_240deg,rgba(255,255,255,0.2)_240deg_360deg)]
    bg-[length:8px_8px]
    bg-[position:0_0,4px_4px]
  `,

  chevron: `
    bg-[repeating-linear-gradient(45deg,rgba(0,0,0,0.2)_0px,rgba(0,0,0,0.2)_2px,transparent_2px,transparent_8px),
        repeating-linear-gradient(-45deg,rgba(0,0,0,0.2)_0px,rgba(0,0,0,0.2)_2px,transparent_2px,transparent_8px)]
    dark:bg-[repeating-linear-gradient(45deg,rgba(255,255,255,0.12)_0px,rgba(255,255,255,0.12)_2px,transparent_2px,transparent_8px),
              repeating-linear-gradient(-45deg,rgba(255,255,255,0.12)_0px,rgba(255,255,255,0.12)_2px,transparent_2px,transparent_8px)]
  `,

  paperGrain: `
    bg-[repeating-linear-gradient(0deg,rgba(0,0,0,0.1)_0px,transparent_1px,transparent_3px),
        repeating-linear-gradient(90deg,rgba(0,0,0,0.1)_0px,transparent_1px,transparent_4px),
        repeating-linear-gradient(45deg,rgba(0,0,0,0.05)_0px,transparent_1px,transparent_5px)]
    dark:bg-[repeating-linear-gradient(0deg,rgba(255,255,255,0.06)_0px,transparent_1px,transparent_3px),
              repeating-linear-gradient(90deg,rgba(255,255,255,0.06)_0px,transparent_1px,transparent_4px),
              repeating-linear-gradient(45deg,rgba(255,255,255,0.04)_0px,transparent_1px,transparent_5px)]
  `,

  horizontalLines: `
    bg-[repeating-linear-gradient(0deg,rgba(0,0,0,0.25)_0px,rgba(0,0,0,0.25)_1px,transparent_1px,transparent_4px)]
    dark:bg-[repeating-linear-gradient(0deg,rgba(255,255,255,0.15)_0px,rgba(255,255,255,0.15)_1px,transparent_1px,transparent_4px)]
  `,

  verticalLines: `
    bg-[repeating-linear-gradient(90deg,rgba(0,0,0,0.25)_0px,rgba(0,0,0,0.25)_1px,transparent_1px,transparent_4px)]
    dark:bg-[repeating-linear-gradient(90deg,rgba(255,255,255,0.15)_0px,rgba(255,255,255,0.15)_1px,transparent_1px,transparent_4px)]
  `,
